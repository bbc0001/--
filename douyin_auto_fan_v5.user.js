...
(function() {
    ...
    const CONFIG = {
        ...
        // 滑动设置
        SCROLL_DELAY_MIN: 2000, // 最小滑动延迟（毫秒）
        SCROLL_DELAY_MAX: 4000, // 最大滑动延迟（毫秒）
    ...
    let shouldScroll = true; // 是否应该继续滑动
    let stats = {
        skipped: 0,
        aLevel: 0,
        sLevel: 0,
    ...
    function init() {
        ...
        console.log('📌 注意：不会主动点赞，仅根据点赞数判断收藏条件');
    ...
    function scrollToNextVideo() {
        if (!shouldScroll || isResting) return;
